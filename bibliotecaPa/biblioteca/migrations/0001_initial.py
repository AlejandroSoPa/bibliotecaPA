# Generated by Django 5.0.4 on 2024-05-02 17:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imatge', models.ImageField(default='default.jpg', null=True, upload_to='fotos_perfil')),
                ('groups', models.ManyToManyField(null=True, related_name='usuari_group', to='auth.group')),
                ('user_permissions', models.ManyToManyField(null=True, related_name='usuarios_permision', to='auth.permission')),
