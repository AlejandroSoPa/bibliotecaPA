...
from biblioteca.models import BR
from datetime import timedelta, datetime

class Command(BaseCommand):
    help = 'Seed the database with dummy data for BR model'
    ...
    def handle(self, *args, **kwargs):
        ...
        for titol, autor in autors.items():
            ...
            durada = durades[titol]  # Aquí se pasa la duración como un objeto timedelta
            estudi = "Nombre del estudio"  # Define el nombre del estudio aquí
            ...
            BR.objects.create(
                ...
                durada=durada,  # Se pasa el objeto timedelta aquí
                estudi=estudi  # Se pasa el nombre del estudio aquí
            )
